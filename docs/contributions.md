...
There will also likely be a Kanban board on the github.
 ...
 - [ ] Render Backends
	- [ ] Create vulkan interfaces
		 >  - Include hooks into interface where applicable for end user.
		 >  - Make extremely modular and well organized.
	...
	- [ ] Create Progressive Renderer derived from base class.
		- [ ] Implement base class methods using vulkan interfaces
		- [ ] Implement Progressive Renderer specific features
